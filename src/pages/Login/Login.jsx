...
const Login = () => {
    ...
    const handleResetPassword =()=>{
        ...
        if(!email){
           return toast.error('To reset password, enter your email')
        }
        console.log(email)
        resetPassword(email)
        .then(()=> toast.success('Password reset link send to your email'))
            ...
            <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                ...
                >
                    ...
                    <div>
                        <button
                            type='submit'
                            className='bg-rose-500 w-full rounded-md py-3 text-white te'
                        >
                            {isLoading ? <TbFidgetSpinner className='mx-auto animate-spin' size={20} /> : 'Continue'}
                        </button>
                    </div>
                </form>
